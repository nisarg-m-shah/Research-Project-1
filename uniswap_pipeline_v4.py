...
v4: adds fee tier as numeric (ordinal), tick-spacing-normalized range width,
    log-transformed deposit size, LP prior-experience count, decrease_event_count,
    and a range/recent-trading overlap feature from swap_agg's min_tick/max_tick.
"""
...
pos_labeled_base.to_csv("final_merged_dataset_v4.csv", index=False)