...
v3: adds pre-open market-condition features (entry price, rolling volatility,
    momentum, recent swap volume) on top of v2's position/outcome features.
"""
...
# ============================================================
# STEP 2: Join mint_data (ticks + open_time) to open_events (tokenId)
# ============================================================
...
final_cols = [
    ...
    'tickLower', 'tickUpper',
    'pool_address', 'token0_address', 'token1_address', 'pool_fee_tier',
...
print(f"Final labeled dataset with market-condition features: {len(pos_labeled_base)} positions")
print(pos_labeled_base['profitable'].value_counts(normalize=True))

print("Saving final dataset to csv")
pos_labeled_base.to_csv("final_merged_dataset_v3.csv", index=False)